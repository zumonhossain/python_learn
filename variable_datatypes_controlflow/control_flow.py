...
#========================
print("Ternary Operator with user input")
#==========================
billing_number = int(input("billing number: "))
result = "bill already paid!" if billing_number == 12345 else "transaction successful!"
print(result)
